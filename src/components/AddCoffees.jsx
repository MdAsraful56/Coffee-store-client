    ...
    return (
        <div>
            <div className="relative">
                ...
                <div className="absolute inset-0 mt-10 px-52">
                    <Link to='/'>
                        <h4 className="text-2xl rancho-font gap-2 flex flex-row items-center"> <span><FaArrowLeft /></span> Back to home</h4>
                    </Link>
                    <div className="text-center raleway-font bg-[#F4F3F0] ">
                        <h1 className="text-4xl rancho-font">Add New Coffee</h1>
                        <p className="px-40">It is a long established fact that a reader will be distraceted by the readable content of a page when looking at its layout.It is a long established fact that a reader will be distraceted by the readable.</p>
                        <form >
